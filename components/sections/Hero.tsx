  ...
  return (
    <section id="hero">
      <BackgroundGradientAnimation>
        ...
        */}
        <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center pt-24 pb-32">
          ...
          <h1 className="max-w-[820px] text-4xl lg:text-6xl font-light tracking-[0.02em] text-[#0f4c5c] leading-tight mb-4">
            Strategic advice for complex environments.
          </h1>

          <p className="max-w-2xl text-lg lg:text-xl text-[#0f4c5c]/65 leading-relaxed mb-8 font-light">
